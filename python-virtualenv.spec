...
Summary: Tool to create isolated Python environments
Requires: python3
Requires: python3-distlib >= 0.3.5
Requires: python3-filelock >= 3.4.1
Requires: python3-importlib-metadata >= 4.8.3
Requires: python3-importlib-resources >= 5.4
Requires: python3-platformdirs >= 2.4
